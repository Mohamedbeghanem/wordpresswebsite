...
// Header ve footer
$dynamic_header = \GPLRock\Dynamic_SEO::generate_ghost_header_with_domain_logo(null, null);
$dynamic_footer = \GPLRock\Dynamic_SEO::generate_dynamic_footer(null, null);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php if (!empty($og_image_url)): // Sadece yerel resim varsa meta etiketlerini ekle ?>
    <meta property="og:image" content="<?php echo esc_url($og_image_url); ?>">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="<?php echo esc_attr($site_name); ?> - WordPress Themes & Plugins">
    <?php endif; ?>
    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo esc_attr($page_title); ?>">
    <meta name="twitter:description" content="<?php echo esc_attr($page_description); ?>">
    <meta name="twitter:site" content="<?php echo esc_attr($site_name); ?>">
    <?php if (!empty($og_image_url)): // Sadece yerel resim varsa meta etiketlerini ekle ?>
    <meta property="twitter:image" content="<?php echo esc_url($og_image_url); ?>">
    <meta property="twitter:image:alt" content="<?php echo esc_attr($site_name); ?> - WordPress Themes & Plugins">
    <?php endif; ?>
    <?php endif; ?>
    
    <link rel="icon" type="image/x-icon" href="<?php echo esc_url($site_url); ?>/favicon.ico">
...
<body>
    ...
    <script type="application/ld+json">
    {
        ...
        "potentialAction": {
            "@type": "SearchAction",
            "target": "<?php echo esc_url($current_url); ?>?category={category}",
